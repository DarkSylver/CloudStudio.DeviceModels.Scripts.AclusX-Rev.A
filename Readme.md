...
# Parsing + Configuration Script – AclusX - Rev. A

This **Parsing + Configuration** script is designed for the **AclusX** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – AclusX Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **AclusX** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
